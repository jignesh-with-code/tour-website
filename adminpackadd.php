...
if(isset($_GET['delete'])){
   ...
   header('location:adminpackadd.php');
}
...
<head>
   ...
   <link rel="stylesheet" href="css1/admin_style.css">
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="adminpackadd.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
         <a href="adminpackadd.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
